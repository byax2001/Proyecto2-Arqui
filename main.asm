...
pkillEnemy1 proc
    movVariablesDw borrE1x,bala1x
    mIncVar borrE1x,4t 
    mDrawEBColision borrE1x,borrE1y
    mDecVar borrE1x,3 
    ret 
pkillEnemy1 endp 
